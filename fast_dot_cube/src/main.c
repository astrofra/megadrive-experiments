...
static void fastCubeFX(){
	...
	static u16 inline drawMiddleSprite(u16 idx, u16 x1, u16 y1, u16 x2, u16 y2)
	{
		u16 x3, y3;
		x3 = (x1 + x2) >> 1;
		y3 = (y1 + y2) >> 1;
	...
	static void drawDots(Sprite *sprites, u16 rx, u16 ry)
	{
		...
		/* Face #0 */
		loop = drawMiddleSprite(loop, t_vtx_2d[0].x, t_vtx_2d[0].y, t_vtx_2d[1].x, t_vtx_2d[1].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[1].x, t_vtx_2d[1].y, t_vtx_2d[2].x, t_vtx_2d[2].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[2].x, t_vtx_2d[2].y, t_vtx_2d[3].x, t_vtx_2d[3].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[0].x, t_vtx_2d[0].y, t_vtx_2d[3].x, t_vtx_2d[3].y);

		/* Face #1 */
		loop = drawMiddleSprite(loop, t_vtx_2d[4].x, t_vtx_2d[4].y, t_vtx_2d[5].x, t_vtx_2d[5].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[6].x, t_vtx_2d[6].y, t_vtx_2d[5].x, t_vtx_2d[5].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[6].x, t_vtx_2d[6].y, t_vtx_2d[7].x, t_vtx_2d[7].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[4].x, t_vtx_2d[4].y, t_vtx_2d[7].x, t_vtx_2d[7].y);

		loop = drawMiddleSprite(loop, t_vtx_2d[0].x, t_vtx_2d[0].y, t_vtx_2d[4].x, t_vtx_2d[4].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[1].x, t_vtx_2d[1].y, t_vtx_2d[5].x, t_vtx_2d[5].y);
		loop = drawMiddleSprite(loop, t_vtx_2d[2].x, t_vtx_2d[2].y, t_vtx_2d[6].x, t_vtx_2d[6].y);
		// loop = drawMiddleSprite(loop, t_vtx_2d[3].x, t_vtx_2d[3].y, t_vtx_2d[7].x, t_vtx_2d[7].y);
