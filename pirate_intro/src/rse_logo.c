...
void displayRSELogoFX(void)
{
	...
	/* Draw the background */
	VDP_drawImageEx(PLAN_A, &shield_anim, TILE_ATTR_FULL(PAL0, FALSE, FALSE, FALSE, vramIndex), 0, 0, FALSE, FALSE);
	VDP_drawImageEx(PLAN_A, &shield_anim, TILE_ATTR_FULL(PAL0, FALSE, FALSE, FALSE, vramIndex), 0, 8, FALSE, FALSE);
	VDP_drawImageEx(PLAN_A, &shield_anim, TILE_ATTR_FULL(PAL0, FALSE, FALSE, FALSE, vramIndex), 0, 16, FALSE, FALSE);
	VDP_drawImageEx(PLAN_A, &shield_anim, TILE_ATTR_FULL(PAL0, FALSE, FALSE, FALSE, vramIndex), 0, 24, FALSE, FALSE);
	vramIndex += shield_anim.tileset->numTile;

	/* Draw the foreground */
	for(i = 1; i < (224 - 120) >> 4; i++)
