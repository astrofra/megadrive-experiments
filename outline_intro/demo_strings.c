...
const char *strings_greets[] = 
{
	...
	*/
	...
	" \0",
	" \0",	
	"DARKLITE, DEFENCE FORCE, DESIRE\0",
	" \0",	
	"FLUSH, FOCUS DESIGN, INSANE, LEMON\0",
	" \0",	
	"LIVE!, LOONIES, MANKIND, MANDARINE,\0",
	" \0",	
	...
	" \0",	
	"ALKAMA, BAUDSURFER, MOG, PHAAZON\0",
	" \0",
	"STFSUX, PLAYMOGAMES ORLEANS\0", 
	" \0",
